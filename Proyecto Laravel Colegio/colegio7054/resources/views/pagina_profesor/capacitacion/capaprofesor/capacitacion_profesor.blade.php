...
@section('content_header')
    <div class="header-container">
        ...
        <h1 class="sec">CURSOS DE CAPACITACIONES PARA DOCENTES</h1>
    </div>
@endsection
    ...
    <div class="row">
        ...
        <div class="col-md-6 curso-card" data-nivel="celeste">
            <div class="card" style="background-image: url('{{ asset('imagenes/fondo2.jpg') }}'); background-size: cover;">
                ...
                <div class="card-body">
                    <p>Este curso enseña los fundamentos para aprender a organizar tus clases, definir objetivos claros y estructurar actividades para maximizar el aprendizaje..</p>
...
@section('css')
 <style>
    ...
    .card-header-avanzado {
        background-color: #FF5733; /* Avanzados */
        color: white;
        font-weight: bold;
    }
    .card-header-intermedio {
        background-color: #33FF57; /* Intermedio */
        color: white;
        font-weight: bold;
    }
    .card-header-basico {
        background-color: #33C1FF; /* Basico */
        color: white;
        font-weight: bold;
    }
